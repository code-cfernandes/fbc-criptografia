...
class AtaqueIntegral {
  ...
  /** @returns {[Buffer, number]} XOR de 256 keystreams e quantos bytes deram zero */
  somarVariando(alvo, chave, ivBase, campo, pos) {
    let xor = Buffer.alloc(this.tamanhoBloco);
    for (let v = 0; v < 256; v++) {
