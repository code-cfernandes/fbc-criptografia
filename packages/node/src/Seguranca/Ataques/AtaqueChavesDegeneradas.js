...
class AtaqueChavesDegeneradas {
  ...
  executar(alvo) {
    ...
    const primeiro = alvo.gerarKeystreamBruto(alvo.chaveDeTeste(), ivZero, 'enc', this.tamanhoBloco);
    if (primeiro == null) {
...
module.exports = AtaqueChavesDegeneradas;
