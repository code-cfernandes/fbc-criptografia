...
const { randomInt, randomBytes, bitsDiferentes } = require('../Util.js');
...
class AtaqueAvalancheChave {
  constructor({ amostras = 3000, tamanhoBloco = 32, limiteMedia = 0.45, limitePiorCaso = 0.3 } = {}) {
...
module.exports = AtaqueAvalancheChave;
