 ...
 */
export class AtaqueSAC implements AtaqueInterface {
  ...
  constructor({
    ...
    amostras = 40,
    tolerancia = 0.05,
  }: { tamanhoBloco?: number; amostras?: number; tolerancia?: number } = {}) {
  ...
  executar(alvo: AlvoCriptografico): ResultadoAtaque {
    ...
    const flips = new Array<number>(totalBits).fill(0);
    ...
    return new ResultadoAtaque(
      ...
      detalhes,
      { pior, pior_p: piorP, desvio: piorDesvio },
    );
  }
}
