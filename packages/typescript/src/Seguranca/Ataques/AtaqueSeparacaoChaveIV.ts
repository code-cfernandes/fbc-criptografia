...
interface OpcoesSeparacaoChaveIV {
  tentativas?: number;
  tamanhoBloco?: number;
}
 ...
 */
export class AtaqueSeparacaoChaveIV implements AtaqueInterface {
  private readonly tentativas: number;
  private readonly tamanhoBloco: number;

  constructor({ tentativas = 50, tamanhoBloco = 32 }: OpcoesSeparacaoChaveIV = {}) {
